...
![Capa Ensaio de Machine Learning]( img/ml_2.jpg)
...
dados.
## Insight Top 4
Os algoritmos de regressão polonimial apresentam uma facilidade maior de sofrer o overfiting, devido a sua fácil adaptação à complexidade dos dados, esses algoritmos não generalizam bem com graus de polinômios elevados.
...
![clusterizacao_treinamento]( img/clus.png)
# Conclusão
